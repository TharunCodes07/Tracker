...
import { CalendarDays, FolderKanban, PencilLine, Trash2 } from "lucide-react";
    ...
    <>
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1 space-y-3 pr-12">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant={project.teamCanEdit ? "outline" : "secondary"}>
                {project.teamCanEdit ? "Editable" : "Read only"}
              </Badge>
            </div>
      ...
      <CardContent className="grid gap-4 border-t border-border/60 pt-4 pb-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          ...
          <div className="text-sm font-medium text-foreground">{project.teamName}</div>
        </div>
