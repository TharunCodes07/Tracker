        ...
        {issues.map((issue) => {
          ...
          return (
            <Card
              ...
              onKeyDown={(event) =>
                handleCardKeyDown(event, issue, onIssueClick)
              }
              className={cn(
              ...
              <CardContent className="space-y-2.5 px-4 py-3">
                ...
                {(issue.developmentStatus || issue.deploymentStatus) && (
                  <div className="flex flex-wrap gap-1 pt-1">
                    <Badge
                      variant="outline"
                      className="border-blue-500/30 bg-blue-500/10 text-blue-700 dark:text-blue-300 text-xs py-0"
                    >
                    ...
                    <Badge
                      variant="outline"
                      className="border-emerald-500/30 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 text-xs py-0"
                    >
...
function QueueStackFrame() {
  return (
    <>
      <QueueCard
        className="left-1/2 top-0 w-[78%] -translate-x-1/2"
        delay={0}
        rows={2}
      />
      <QueueCard
        className="left-1/2 top-11 w-[84%] -translate-x-1/2"
        delay={160}
        rows={2}
      />
      <QueueCard
        className="left-1/2 top-[5.5rem] w-[76%] -translate-x-1/2"
        delay={320}
        rows={2}
      />
    </>
...
function QueueCard({
  ...
  return (
    <div className={cn("absolute", className)}>
      <div
        className="tracker-empty-jiggle rounded-2xl border border-border/70 bg-background p-3 shadow-sm"
