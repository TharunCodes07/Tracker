...
export function TeamsGridSkeleton({ count = 6 }: TeamsGridSkeletonProps) {
  return (
...
export function TeamsTableSkeleton({ rows = 8 }: TeamsTableSkeletonProps) {
  return (
    <section className="rounded-[28px] border border-border/60 bg-card/80 p-4 shadow-sm">
      ...
      <div className="overflow-hidden rounded-2xl border border-border/60">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="w-[30%] whitespace-normal text-center">
                <Skeleton className="mx-auto h-4 w-20" />
              </TableHead>
              <TableHead className="w-[18%] whitespace-normal text-center">
