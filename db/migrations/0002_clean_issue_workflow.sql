...
--> statement-breakpoint
DROP TABLE IF EXISTS "issue_classes" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "issues" CASCADE;
--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN IF NOT EXISTS "key_prefix" varchar(12) DEFAULT 'PROJ' NOT NULL;
--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN IF NOT EXISTS "next_issue_number" integer DEFAULT 1 NOT NULL;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "project_components_project_name_unique" ON "project_components" USING btree ("project_id","name");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "issue_comments_organization_id_idx" ON "issue_comments" USING btree ("organization_id");
--> statement-breakpoint
CREATE INDEX "issue_comments_project_id_idx" ON "issue_comments" USING btree ("project_id");
--> statement-breakpoint
CREATE INDEX "issue_comments_issue_id_idx" ON "issue_comments" USING btree ("issue_id");
--> statement-breakpoint
CREATE INDEX "issue_comments_author_id_idx" ON "issue_comments" USING btree ("author_id");
--> statement-breakpoint
CREATE INDEX "issue_activity_organization_id_idx" ON "issue_activity" USING btree ("organization_id");
--> statement-breakpoint
CREATE INDEX "issue_activity_project_id_idx" ON "issue_activity" USING btree ("project_id");
--> statement-breakpoint
CREATE INDEX "issue_activity_issue_id_idx" ON "issue_activity" USING btree ("issue_id");
--> statement-breakpoint
CREATE INDEX "issue_activity_actor_id_idx" ON "issue_activity" USING btree ("actor_id");
--> statement-breakpoint
CREATE INDEX "issue_links_organization_id_idx" ON "issue_links" USING btree ("organization_id");
--> statement-breakpoint
CREATE INDEX "issue_links_project_id_idx" ON "issue_links" USING btree ("project_id");
--> statement-breakpoint
CREATE INDEX "issue_links_source_issue_id_idx" ON "issue_links" USING btree ("source_issue_id");
--> statement-breakpoint
CREATE INDEX "issue_links_target_issue_id_idx" ON "issue_links" USING btree ("target_issue_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "issue_links_source_target_type_unique" ON "issue_links" USING btree ("source_issue_id","target_issue_id","link_type");
--> statement-breakpoint
ALTER TABLE "project_components" ENABLE ROW LEVEL SECURITY;
--> statement-breakpoint
ALTER TABLE "project_components" FORCE ROW LEVEL SECURITY;
--> statement-breakpoint
CREATE POLICY "project_components_organization_isolation" ON "project_components"
...
--> statement-breakpoint
CREATE POLICY "project_releases_organization_isolation" ON "project_releases"
  USING ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid)
  WITH CHECK ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE POLICY "sprints_organization_isolation" ON "sprints"
  USING ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid)
  WITH CHECK ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE POLICY "issue_comments_organization_isolation" ON "issue_comments"
  USING ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid)
  WITH CHECK ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid);
--> statement-breakpoint
ALTER TABLE "issue_activity" ENABLE ROW LEVEL SECURITY;
--> statement-breakpoint
ALTER TABLE "issue_activity" FORCE ROW LEVEL SECURITY;
--> statement-breakpoint
CREATE POLICY "issue_activity_organization_isolation" ON "issue_activity"
  USING ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid)
  WITH CHECK ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE POLICY "issue_links_organization_isolation" ON "issue_links"
  USING ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid)
  WITH CHECK ("organization_id" = nullif(current_setting('app.current_organization_id', true), '')::uuid);
